...
saveRDS(rangerModel_t, paste0("../data/models/03_rangerModel_all_", response, j, ".rds"))
tictoc::toc()
...
saveRDS(xgbModel_t, paste0("../data/models/03_xgbModel_all_", response, j, "_TLCUSTOM.rds"))
tictoc::toc()
...
saveRDS(gbmModel_t, paste0("../data/models/03_gbmModel_all_", response, j, ".rds"))
tictoc::toc()
  
saved_models <- list(rangerModel_t, xgbModel_t, gbmModel_t)

saveRDS(saved_models, paste0("../data/RData/03_hyper_para_tuning_", response, j, "_models_list.rds"))
