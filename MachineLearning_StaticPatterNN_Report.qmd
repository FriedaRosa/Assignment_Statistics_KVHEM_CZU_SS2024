...
venn.plot <- venn.diagram(r_squared_list, filename = NULL)
...
#### Final models 
##### Insights:
1. Random Forest with Ranger
Keeping in mind that splitrule = "extratrees" ignores the mtry argument (and rather performs random selection of variables). This should prevent overfitting and achieves a similar performance to mtry = intermediate number and splitrule = "variance". 
